    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          {badge && (
            <span className="text-[10px] bg-accent-100 text-accent-700 px-2 py-0.5 rounded-full font-medium whitespace-nowrap flex-shrink-0">
              {badge}
            </span>
          )}
        </div>
        <svg
          className={`w-4 h-4 text-gray-300 transition-transform flex-shrink-0 ml-2 ${expanded ? 'rotate-180' : ''}`}
